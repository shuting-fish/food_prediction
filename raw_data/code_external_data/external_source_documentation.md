...
This document is based only on repository evidence available in the current post-PR29 branch state verified for the 2026-05-11 `zipcode_to_municipality_reference` source-QA/reference-mapping consistency update:
- verified branch for this update: master
- verified HEAD for this update: 586460e1e85647d346901e8c76d924dab1d53e95
